...
Based on this, follow the following verification instructions expressed in natural language to create a Lean 4 proof: note that the lean proof can also be incorrect. DO NOT CORRECT ANY CLAIM. DO NOT OUPUT ANYTHING BUT LEAN 4 CODE: {input}
"""